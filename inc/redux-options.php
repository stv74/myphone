...
$args = array(
	...
	'menu_title'                => esc_html__( 'Shop Options', 'ministore' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Shop Options', 'ministore' ),
...
$args['share_icons'][] = array(
	'url'   => '//github.com/stv74',
	'title' => 'Visit me on GitHub',
	'icon'  => 'el el-github',
);
$args['share_icons'][] = array(
	'url'   => '//www.facebook.com/profile.php?id=100001952990570',
	'title' => 'Like me on Facebook',
	'icon'  => 'el el-facebook',
);
$args['share_icons'][] = array(
	'url'   => '//twitter.com/samojlov',
...
// 	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'ministore' ), '<strong>' . $v . '</strong>' ) . '<p>';
// } else {
// 	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'ministore' ) . '</p>';
// }

// Add content after the form.
// $args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'ministore' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'ministore' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'ministore' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'ministore' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'ministore' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'ministore' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Site logo', 'ministore' ),
		'id'               => 'site_logo',
		'desc'             => esc_html__( 'Set your site logo here', 'ministore' ),
		...
		'fields'           => array(
			array(
				...
				'type'     => 'media',
				'url'      => true,
				'title'    => esc_html__( 'Logo upload', 'ministore' ),
				'subtitle' => esc_html__( 'Upload an image of your logo in the format .png', 'ministore' ),
				'desc'     => esc_html__( 'Recommended size: 140px-26px', 'ministore' ),
				'default'  => '',
			),
		)
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Basic Fields', 'ministore' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'ministore' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);
...
// 	$opt_name,
// 	array(
// 		'title'            => esc_html__( 'Editors', 'ministore' ),
// 		'id'               => 'editor',
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Color Selection', 'ministore' ),
// 		'id'    => 'color',
// 		'icon'  => 'el el-brush',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Design Fields', 'ministore' ),
// 		'id'    => 'design',
// 		'icon'  => 'el el-wrench',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Media Uploads', 'ministore' ),
// 		'id'    => 'media',
// 		'icon'  => 'el el-picture',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Presentation Fields', 'ministore' ),
// 		'id'    => 'presentation',
// 		'icon'  => 'el el-screen',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Switch / Button Set', 'ministore' ),
// 		'id'    => 'switch_buttonset',
// 		'icon'  => 'el el-cogs',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Select Fields', 'ministore' ),
// 		'id'    => 'select',
// 		'icon'  => 'el el-list-alt',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Slider / Spinner', 'ministore' ),
// 		'id'    => 'slider_spinner',
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Additional Types', 'ministore' ),
// 		'id'    => 'additional',
// 		'icon'  => 'el el-magic',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Advanced Features', 'ministore' ),
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Disabling', 'ministore' ),
// 		'icon'  => 'el el-lock',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Redux Extensions', 'ministore' ),
// 		'id'    => 'redux-extensions',
// 		'icon'  => 'el el-redux',
// 		'class' => 'pro_highlight',
// 		'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'ministore' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
// 	)
// );
...
// 	$section = array(
// 		'icon'   => 'el el-list-alt',
// 		'title'  => esc_html__( 'Documentation', 'ministore' ),
// 		'fields' => array(
// 			array(
...
// 	array(
// 		'icon'            => 'el el-list-alt',
// 		'title'           => esc_html__( 'Customizer Only', 'ministore' ),
// 		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'ministore' ) . '</p>',
// 		'customizer_only' => true,
// 		'fields'          => array(
// 			array(
// 				'id'              => 'opt-customizer-only',
// 				'type'            => 'select',
// 				'title'           => esc_html__( 'Customizer Only Option', 'ministore' ),
// 				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'ministore' ),
// 				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'ministore' ),
// 				'customizer_only' => true,
// 				'options'         => array(
// 					'1' => esc_html__( 'Opt 1', 'ministore' ),
// 					'2' => esc_html__( 'Opt 2', 'ministore' ),
// 					'3' => esc_html__( 'Opt 3', 'ministore' ),
// 				),
// 				'default'         => '2',
// 			),
// 		),
...
// 		$sections[] = array(
// 			'title'  => esc_html__( 'Section via hook', 'ministore' ),
// 			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'ministore' ) . '</p>',
...
// 		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'ministore' );
